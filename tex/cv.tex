...
\item {\normalsize Segmentation: }service aimed to segment users on different criterias, for advanced a/b testing. Tasks: handle all users and business events (20k/second), implement expression dsl on groovy, design api.
\end{itemize}
